...
describe('cloneDeep', () => {
  ...
  it('should clone objects', () => {
    const obj = { a: 1, b: 'test', c: [1, 2, 3], [Symbol()]: 2 };
  ...
  it('should deep clone nested objects', () => {
    const nestedObj = { a: [1, 2, 3], b: { c: 'test' }, d: new Date() };
    const clonedNestedObj = cloneDeep(nestedObj);
    nestedObj.a[2] = 4;
    nestedObj.b.c = 'test-2';
