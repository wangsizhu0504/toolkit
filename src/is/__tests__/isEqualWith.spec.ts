...
describe('isEqualWith', () => {
  ...
  it('should compare primitives when customizer returns undefined', () => {
    const pairs = [
      ...
      [Number.NaN, Object(Number.NaN), true],
      [Object(Number.NaN), Object(Number.NaN), true],
      [Number.NaN, 'a', false],
  ...
  it('should compare symbol properties when customizer returns undefined', () => {
    const _symbol1 = Symbol('a');
    const _symbol2 = Symbol('b');

    const object1: any = { a: 1 };
    const object2: any = { a: 1 };

    object1[_symbol1] = { a: { b: 2 } };
    object2[_symbol1] = { a: { b: 2 } };

    Object.defineProperty(object2, _symbol2, {
      configurable: true,
      enumerable: false,
      writable: true,
      value: 2,
    ...
    object2[_symbol1] = { a: 1 };

    expect(isEqualWith(object1, object2, noop)).toBe(false);

    delete object2[_symbol1];
